...
const CourseCard = ({ course }) => {
    ...
    return (
        <div className="
        p-4 rounded-xl bg-black/10 border-2 border-gray-800 shadow-2xl shadow-black/70 text-black flex flex-col gap-2 hover:scale-105 duration-300 hover:cursor-pointer" onClick={handleCourseClick}>
