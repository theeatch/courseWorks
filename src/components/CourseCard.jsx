...
const CourseCard = ({ course }) => {
    ...
    return (
        <div className="
        p-4 rounded-xl bg-black/20 border-2 border-gray-800 shadow-xl shadow-slate-400 text-black flex flex-col gap-2 hover:scale-105 duration-300 hover:cursor-pointer" onClick={handleCourseClick}>
