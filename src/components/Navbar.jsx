  ...
  return (
    <div className="fixed top-0 w-full z-50 h-24 bg-slate-800/40 rounded-b-xl shadow-md shadow-slate-500/80 flex justify-center items-center backdrop-blur-xl">
      ...
      <div className="w-full md:hidden flex items-center gap-6 p-4">
        ...
        {menuOpen ? (
          <div className="opacity-100 w-1/3 h-1/4 absolute top-0 left-0 rounded-br-xl bg-slate-400 flex flex-col justify-center">
            <div className="text-center text-2xl text-black/60 font-bold p-3 mt-10 underline">
              Dashboard
            </div>
